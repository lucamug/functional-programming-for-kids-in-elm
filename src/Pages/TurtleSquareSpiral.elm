module Pages.TurtleSquareSpiral exposing (view)
...
view =
    Shared.pageSkeleton
        ...
        , notification = []
        , route = Route.RouteTurtleSquareSpiral
        , theRest =
            [ el [ centerX ] <| html <| squareSpiral
            , MarkdownElmUi.stringToElement squareSpiralCode
            ]
        }

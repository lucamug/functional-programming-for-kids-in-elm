...
const elmCanvas = fs.readFileSync("docs/elm-canvas.js", "utf8");
const elmCode = fs.readFileSync("build/TEMP/elm.js", "utf8");
const starter = fs.readFileSync("docs/starter.js", "utf8");
...
fs.writeFileSync("build/TEMP/elm.min.js", result.code);